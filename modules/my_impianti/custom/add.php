...
?><form action="editor.php?id_module=$id_module$" method="post">
	...
	<div class="row">
		...
		<div class="col-md-6">
			{[ "type": "text", "label": "<?php echo tr('Referente Impianto'); ?>", "name": "occupante", "class": "text-center", "value": "" ]}
		</div>

		<div class="col-md-6">
		  {[ "type": "select", "label": "<?php echo tr('Tipo impianto'); ?>", "name": "idtipoimpianto", "required": 1, "values": "query=SELECT id, descrizione FROM my_impianti_tipiimpianto", "value": "" ]}
		</div>';
