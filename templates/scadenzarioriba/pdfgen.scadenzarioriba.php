...
$add_where = "AND co_scadenziario.riba_da_pres=1 AND co_tipidocumento.id = 2 ";
...
$body .= "<col width=\"100\"><col width=\"120\"><col width=\"10\"><col width=\"50\"><col width=\"80\"><col width=\"70\"><col width=\"180\"><col width=\"50\"><col width=\"50\">\n";
...
WHERE ABS(pagato) < ABS(da_pagare) ".$add_where." AND data_emissione >= '".$_SESSION['period_start']."' AND data_emissione <= '".$_SESSION['period_end']."' ORDER BY scadenza ASC");
